...
echo ""
echo "This will create a fresh Ubuntu 24.04 container to test the devbox setup."
...
echo ""
echo "You are now in a test Ubuntu system as user 'sean'"
echo "To test the setup, run: cd ~/devbox && ./bootstrap"
echo ""
